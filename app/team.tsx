          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div
                  className={`w-14 h-14 rounded-full border-2 flex items-center justify-center font-black text-lg select-none flex-shrink-0 ${member.avatarBg}`}
                >
                  {member.initials}
                </div>
                <div className="flex flex-col">
                  <h3 className="text-2xl md:text-3xl font-black tracking-tight text-black dark:text-white uppercase leading-none">
                    {member.name}
                  </h3>
                  <span className="text-xs font-bold text-amber-500 uppercase tracking-wide mt-1.5">
                    {member.role}
                  </span>
                </div>
              </div>
              ...
              {/* Bio Paragraphs */}
              <div className="space-y-4 text-sm font-light text-zinc-600 dark:text-zinc-400 leading-relaxed">
                <p>{member.bio1}</p>
                <p>{member.bio2}</p>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-zinc-200/60 dark:border-zinc-800/60 mt-auto">
              <p className="text-xs italic font-light text-zinc-500 dark:text-zinc-400 leading-relaxed">
                {member.footerQuote}
              </p>
            </div>
          </motion.div>
